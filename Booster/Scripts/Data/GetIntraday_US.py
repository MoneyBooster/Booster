...
def stockPriceIntraday(ticker, folder):
	...
	url = 'https://www.alphavantage.co/query?apikey=MLG92LA5SYPM8357&function=TIME_SERIES_INTRADAY&symbol={ticker}&interval=1min&outputsize=full&datatype=csv'.format(ticker=ticker)
